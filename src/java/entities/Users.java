...
@NamedQueries({
    ...
    , @NamedQuery(name = "Users.isExists", query = "SELECT u FROM Users u WHERE u.email = :email or u.username = :username")
...
public class Users implements Serializable {
    ...
    public Users(Integer id, String username, String email, String password, boolean isAdmin) {
        this.id = id;
